...
module.exports = class CacheHandler {
  ...
  static {
    this.kvStoreURL = "http://localhost:8083/kv";
  }
  async get(key) {
    key = key.replace(/^\/+/g, "");
    ...
    try {
      const response = await instance.get(`${CacheHandler.kvStoreURL}/${key}`);
      console.log(`Cache Duration: ${response.headers["request-duration"]} ms`);
